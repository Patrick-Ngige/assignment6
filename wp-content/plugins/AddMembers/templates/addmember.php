<div style="width:50%; display:flex; flex-direction:column; justify-content:center; align-items:center; margin-left: 20em; margin-top:1em;">
    ...
    <form method="post" style="width:30vw; box-shadow: 2px 2px 2px 2px grey;padding: 2em 3em; line-height: 2em; border-radius: 5px; background-color:#FFFFFF">
        ...
        <div>
            <label>Name:</label><br>
            <input type="text" style="width:100%;" placeholder="Enter name" name="fname" required>
        </div>
        <div>
            <label>Phone Number: </label><br>
            <input type="text" style="width:100%;" placeholder="Enter phone number " name="p_number" required><br>

        </div>
        <div>
            <label>Email: </label><br>
            <input type="email" style="width:100%;" placeholder="Enter product description" name="email" required><br>
